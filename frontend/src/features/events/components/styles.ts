export const eventUi = {
  ...
  calendarRoot: 'w-full',
  calendarToolbarButton: 'mx-20 grid size-8 place-items-center rounded border-0 bg-[#eff4ff] text-[#0b1c30] disabled:cursor-not-allowed disabled:opacity-[.45]',
  ...
  timeSelectItem: 'h-8',
  timeSelectTrigger: 'h-[42px] w-full rounded border border-[#6b7280] bg-white px-3 text-sm text-[#0b1c30] outline-0 focus:border-[#009b4d] focus:shadow-[0_0_0_2px_#009b4d26]',
