...
export function EventHeader({
  ...
  const canOpenMySchedule = Boolean(myScheduleHref) && event.status === 1 && !disabled;
    ...
    <header className="mb-8 flex flex-wrap items-start justify-between gap-6">
      ...
      <div className="min-w-0 w-full shrink-0 space-y-3 sm:w-72">
        ...
        <a
          ...
          className="block w-full rounded-lg bg-primary px-4 py-3 text-center text-sm font-semibold text-primary-foreground shadow-sm hover:bg-primary/90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring aria-disabled:cursor-not-allowed aria-disabled:opacity-60"
        >
          My Schedule
        </a>
      </div>
